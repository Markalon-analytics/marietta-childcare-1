...
- 2026-06-08: Use light source facts from BBMA Marietta but omit BBMA/Big Blue/Passport branded terms from public output. Superseded on 2026-06-09 by the light BBMA location-finder direction.
- 2026-06-08: Route schedule-tour CTAs to local `/contact`; use verified phone only for direct call links. Superseded on 2026-06-09 by external BBMA form routing.
...
- 2026-06-09: Change public brand boundary from hidden BBMA source alignment to light BBMA location-finder positioning. Primary CTAs now route to the official BBMA form, and `/contact` is owned by a forced Netlify external redirect.
